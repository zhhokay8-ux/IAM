...
@Repository
public class NonceRepository extends IamRedisRepository {

    private final IamRedisProperties properties;

    public NonceRepository(StringRedisTemplate redisTemplate, IamRedisProperties properties) {
        super(redisTemplate);
        this.properties = properties;
    }

    public void save(String value, String payload) {
        save(RedisKeyConstants.nonce(value), payload, properties.getNonceTtl());
    }

    public Optional<String> get(String value) {
        return super.get(RedisKeyConstants.nonce(value));
    }

    public boolean delete(String value) {
        return super.delete(RedisKeyConstants.nonce(value));
    }

    public Duration getTtl(String value) {
        return getExpire(RedisKeyConstants.nonce(value));
    }
}
